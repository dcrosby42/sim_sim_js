 ...
 */
	...
	function onLoad()
	{
        ...
        const loader = new PIXI.AssetLoader(["pixibox_assets/ball.png",
    ...
    function onLoadAssets()
    {
        ...
        for (var i = 0; i < 40; i++)
        {
            ...
            if (Math.random() > 0.5)
            {
                ...
                var ball = new PIXI.Sprite(PIXI.Texture.fromFrame("pixibox_assets/ball.png"));
                stage.addChild(ball);
                ball.i = i;
            ...
            else
            {
                ...
                var box = new PIXI.Sprite(PIXI.Texture.fromFrame("pixibox_assets/box.jpg"));
                stage.addChild(box);
                box.i = i;
